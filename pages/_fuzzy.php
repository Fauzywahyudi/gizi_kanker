...
?>
    ...
    <img src="src/img/grafik/umur.png" class="img-fluid" alt="Grafik Suhu">
    <br>
<?php
}
...
?>
    ...
    <img src="src/img/grafik/beratbadan.png" class="img-fluid" alt="Grafik Kelembapan">
    <br>
<?php
}
...
?>
    ...
    <img src="src/img/grafik/tinggibadan.png" class="img-fluid" alt="Grafik Tinggi Air">
    <br>
<?php
}
...
?>
    ...
    <img src="src/img/grafik/stadium.png" class="img-fluid" alt="Grafik Tinggi Air">
    <br>
<?php
}
...
?>
    ...
    <img src="src/img/grafik/statusgizi.png" class="img-fluid" alt="Grafik Debit Irigasi">
    <br>
<?php
}
...
function inferensi($umur, $berat, $tinggi, $stadium)
{
    ...
    // echo '<img src="src/img/defuzzifikasi.jpg" class="img-fluid" alt="Grafik Debit Irigasi">';
